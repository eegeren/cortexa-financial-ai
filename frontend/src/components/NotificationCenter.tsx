...
const NotificationCenter = () => {
  ...
  return (
    <div className="relative"> 
      ...
      {open && (
        <div className="absolute right-0 z-[200] mt-3 w-[min(320px,calc(100vw-1rem))] rounded-2xl border border-slate-800 bg-slate-950/95 p-4 shadow-2xl backdrop-blur">
