...
import BotOrdersPage from '@/pages/BotOrders';
import SignalStatsPage from '@/pages/SignalStats';
      ...
      <AnimatePresence mode="wait" initial={false}>
        <Routes location={location} key={location.pathname}>
          ...
          <Route element={<Layout />}>
            ...
            <Route path="/stats" element={<ProtectedRoute><PremiumRoute><SignalStatsPage /></PremiumRoute></ProtectedRoute>} />
            <Route path="/bot/settings" element={<ProtectedRoute><PremiumRoute><BotSettingsPage /></PremiumRoute></ProtectedRoute>} />
            <Route path="/bot/orders" element={<ProtectedRoute><PremiumRoute><BotOrdersPage /></PremiumRoute></ProtectedRoute>} />
