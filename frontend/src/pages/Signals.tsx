...
const SignalsPage = () => {
  ...
  return (
    <div className="flex flex-col gap-5 lg:gap-6">
      ...
      <section
        ref={resultsRef}
        className="grid scroll-mt-24 gap-5 lg:grid-cols-[minmax(0,1.45fr)_minmax(300px,380px)]"
      >
          ...
          <div className={`mt-6 transition-opacity duration-300 ${signalLoading ? 'opacity-100' : 'opacity-100'}`}>
            {signalLoading ? (
              ...
              <div className="space-y-6">
                <section className="grid gap-4 lg:grid-cols-[minmax(0,1.2fr)_minmax(260px,360px)]">
                ...
                <section className="grid gap-4 lg:grid-cols-[minmax(0,1.15fr)_minmax(280px,360px)]">
                  ...
                  <div>
                    ...
                    <div className="mt-3 space-y-2 text-xs text-slate-300">
                      {confidenceBucketPreview.map((bucket) => (
                        <div key={bucket.bucket} className="grid grid-cols-[60px_36px_1fr_1fr] items-center gap-2 rounded-2xl border border-outline/20 bg-muted/50 px-3 py-2 sm:grid-cols-[72px_44px_1fr_1fr] sm:gap-3">
                  ...
                  <div>
                    ...
                    <div className="mt-3 space-y-2 text-xs text-slate-300">
                      {scoreBucketPreview.map((bucket) => (
                        <div key={bucket.bucket} className="grid grid-cols-[72px_36px_1fr_1fr] items-center gap-2 rounded-2xl border border-outline/20 bg-muted/50 px-3 py-2 sm:grid-cols-[92px_44px_1fr_1fr] sm:gap-3">
                          <span className="text-slate-200">{bucket.bucket}</span>
