...
const SettingsPage = () => {
  ...
  return (
    <div className="space-y-8 sm:space-y-12 lg:space-y-16">
      ...
      <section id="security" className="rounded-3xl border border-outline/40 bg-surface p-5 shadow-elevation-soft sm:p-6">
      ...
      <section id="notifications" className="rounded-3xl border border-outline/40 bg-surface p-5 shadow-elevation-soft sm:p-6">
      ...
      <section className="rounded-3xl border border-outline/40 bg-surface p-5 shadow-elevation-soft text-xs text-slate-300 sm:p-6">
