...
func Load() Config {
	cfg := Config{
		...
		EncryptionKey:             strings.TrimSpace(getenv("CORTEXA_ENCRYPT_KEY", "change-me-cortexa-bot-key")),
		...
		NowPaymentsAPIKey:         strings.TrimSpace(getenv("NOWPAYMENTS_API_KEY", "")),
		NowPaymentsIPNSecret:      strings.TrimSpace(getenv("NOWPAYMENTS_IPN_SECRET", "")),
		NowPaymentsPaymentURL:     strings.TrimSpace(getenv("NOWPAYMENTS_PAYMENT_URL", "")),
